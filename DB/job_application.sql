...
INSERT INTO `jobapptrackerdb`.`job_application` (`id`, `job_title`, `company_name`, `link_to_description`, `salary_low`, `salary_high`, `location_work_model`, `contact_at_company`, `contact_notes`, `my_interest_level`, `app_status`, `offer_made`, `date_of_apply`, `date_of_offer`, `follow_up`, `follow_up_date`, `follow_up_note`) VALUES (4, 'Entry/Jr. Software Developer', 'MAXAR', 'https://maxar.wd1.myworkdayjobs.com/en-US/Maxar/job/Entry-Jr-Software-Developer_R15224', 61000, 129000, NULL, NULL, NULL, 7, 'Position Cancelled', false, '2022/07/14', NULL, NULL, NULL, NULL);
INSERT INTO `jobapptrackerdb`.`job_application` (`id`, `job_title`, `company_name`, `link_to_description`, `salary_low`, `salary_high`, `location_work_model`, `contact_at_company`, `contact_notes`, `my_interest_level`, `app_status`, `offer_made`, `date_of_apply`, `date_of_offer`, `follow_up`, `follow_up_date`, `follow_up_note`) VALUES (5, 'Software Engineer - Early Career', 'Lockheed Martin', 'https://sjobs.brassring.com/TGnewUI/Search/home/HomeWithPreLoad?PageType=JobDetails&partnerid=25037&siteid=5010&jobId=679812#jobDetails=679812_5010', 71900, 119800, 'Littleton', NULL, NULL, 8, 'Rejected', false, '2022/07/14', NULL, NULL, NULL, 'Considering other candidates');
INSERT INTO `jobapptrackerdb`.`job_application` (`id`, `job_title`, `company_name`, `link_to_description`, `salary_low`, `salary_high`, `location_work_model`, `contact_at_company`, `contact_notes`, `my_interest_level`, `app_status`, `offer_made`, `date_of_apply`, `date_of_offer`, `follow_up`, `follow_up_date`, `follow_up_note`) VALUES (6, 'Early Career Software Engineer - Embedded Systems Tools', 'BLUE ORIGIN', 'https://www.linkedin.com/jobs/view/2975175662', 76000, 114000, 'Denver', NULL, NULL, 7, 'Rejected', false, '2022/07/14', NULL, NULL, '2022/07/16', 'Rejection email from HR');
...
INSERT INTO `jobapptrackerdb`.`job_application` (`id`, `job_title`, `company_name`, `link_to_description`, `salary_low`, `salary_high`, `location_work_model`, `contact_at_company`, `contact_notes`, `my_interest_level`, `app_status`, `offer_made`, `date_of_apply`, `date_of_offer`, `follow_up`, `follow_up_date`, `follow_up_note`) VALUES (9, 'Junior Software Engineer', 'Dropbox', 'https://www.dropbox.com/jobs/listing/3354694/apply', NULL, NULL, 'Remote', NULL, NULL, 7, 'Applied', false, '2022/08/15', NULL, NULL, NULL, NULL);
INSERT INTO `jobapptrackerdb`.`job_application` (`id`, `job_title`, `company_name`, `link_to_description`, `salary_low`, `salary_high`, `location_work_model`, `contact_at_company`, `contact_notes`, `my_interest_level`, `app_status`, `offer_made`, `date_of_apply`, `date_of_offer`, `follow_up`, `follow_up_date`, `follow_up_note`) VALUES (10, 'Junior Software Engineer', 'Insight Global', 'https://www.linkedin.com/jobs/view/3223503609', 70000, 75000, 'Remote', NULL, NULL, 7, 'Applied', false, '2022/08/16', NULL, NULL, NULL, NULL);
INSERT INTO `jobapptrackerdb`.`job_application` (`id`, `job_title`, `company_name`, `link_to_description`, `salary_low`, `salary_high`, `location_work_model`, `contact_at_company`, `contact_notes`, `my_interest_level`, `app_status`, `offer_made`, `date_of_apply`, `date_of_offer`, `follow_up`, `follow_up_date`, `follow_up_note`) VALUES (11, 'Java Developer - Recent Graduates - Entry Level', 'Cogent University', 'https://www.linkedin.com/jobs/collections/recommended/?currentJobId=3223407786', NULL, NULL, NULL, NULL, NULL, 8, 'Applied', false, '2022/08/16', NULL, NULL, NULL, NULL);
